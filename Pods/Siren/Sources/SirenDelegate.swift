...
public extension SirenDelegate {
    ...
    func sirenDidShowUpdateDialog(alertType _: Siren.AlertType) {
        printMessage()
    }
    ...
    func sirenDidFailVersionCheck(error _: Error) {
        printMessage()
    }

    func sirenDidDetectNewVersionWithoutAlert(message _: String, updateType _: UpdateType) {
        printMessage()
    }
